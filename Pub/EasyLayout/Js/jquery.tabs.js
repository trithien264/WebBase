...
(function ($) {
    ...
    */
    ...
    function selectTab(container, which) {
        //var index = $('#TabLayout').tabs('getTabIndex', $('#TabLayout').tabs('getSelected'));
        ...
        if (selected) {
            //Nickel 20140321:click chon tab hiện hành nó hiện loading
        ...
        //Nickel: them try catch vao de cho phu hop voi trinh duyet firefox
        try{
